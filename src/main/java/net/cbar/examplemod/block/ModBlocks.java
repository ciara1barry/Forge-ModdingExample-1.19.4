...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> NETHERRACK_ONYX_ORE = registerBlock("netherrack_onyx_ore",
            () -> new DropExperienceBlock(BlockBehaviour.Properties.of(Material.STONE)
                    .strength(4f).requiresCorrectToolForDrops(), UniformInt.of(2, 6)));
    public static final RegistryObject<Block> ENDSTONE_ONYX_ORE = registerBlock("endstone_onyx_ore",
            () -> new DropExperienceBlock(BlockBehaviour.Properties.of(Material.STONE)
